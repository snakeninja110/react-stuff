...
export default class Bubble extends Component {
  ...
  componentWillMount () {
    ...
    this.width = this.state.width * this.ratio;
    this.height = this.state.height * this.ratio;
  ...
  componentDidUpdate (prevProps) {
    const { y } = this.props;
    this.distance = Math.max(0, Math.min(y * this.ratio, this.maxDistance));
